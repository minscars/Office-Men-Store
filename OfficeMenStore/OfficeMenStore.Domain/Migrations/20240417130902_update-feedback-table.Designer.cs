...
namespace OfficeMenStore.Domain.Migrations
{
    ...
    [Migration("20240417130902_update-feedback-table")]
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 17, 20, 9, 1, 783, DateTimeKind.Local).AddTicks(5374));
                    ...
                    b.Property<DateTime?>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 17, 20, 9, 1, 783, DateTimeKind.Local).AddTicks(5626));
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.FeedBack", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 17, 20, 9, 1, 783, DateTimeKind.Local).AddTicks(7282));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 4, 17, 20, 9, 1, 789, DateTimeKind.Local).AddTicks(4559),
                            ProductId = 1,
                            Rate = 5.0,
                            UserId = new Guid("8a820adb-93d7-4c6f-9404-bdbfc14419f4")
                        });
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 17, 20, 9, 1, 783, DateTimeKind.Local).AddTicks(4421));
                    ...
                    b.Property<DateTime>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 17, 20, 9, 1, 783, DateTimeKind.Local).AddTicks(4733));
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "kha.jpg",
                            ConcurrencyStamp = "0d119dc3-5794-4011-a1d3-42f7ad715af1",
                            Email = "kha@gmail.com",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBa5yqxfuevzku7EJi38DnwKXcrzOYtA1t29bQCE70QJfq2f2m9QzVFIJniDWcrVhw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "admin.jpg",
                            ConcurrencyStamp = "bc6cc532-6b6b-4765-a83d-fd49cd35669d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPd05P5+xUDPdUkVBbLgTUdwiBl+6Zbg9yYPcvMXbSWPve9lty2UWIKNTqnDzsVtCg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "nhan.jpg",
                            ConcurrencyStamp = "0400ec35-13d5-4d3a-bd28-ebf8261027a1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENNf8e1B4cbr5zheco4eJlPxuOs/bNGMzS6LKGsCvtpe0WYK1SnD+js418Tq8HgPrA==",
                            PhoneNumber = "0123456789",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3ca278a0-cf26-4f62-9ce0-26d6ae5f11be",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2fd97831-855b-4d73-8c63-15c709c80635",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
