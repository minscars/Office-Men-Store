...
namespace OfficeMenStore.Domain.Migrations
{
    ...
    [Migration("20240308071636_update-user-table")]
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 8, 14, 16, 36, 219, DateTimeKind.Local).AddTicks(8780));
                    ...
                    b.Property<DateTime?>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 8, 14, 16, 36, 219, DateTimeKind.Local).AddTicks(9303));
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.FeedBack", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 8, 14, 16, 36, 220, DateTimeKind.Local).AddTicks(3132));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 3, 8, 14, 16, 36, 231, DateTimeKind.Local).AddTicks(1754),
                            ProductId = 1,
                            Rate = 5,
                            UserId = new Guid("8a820adb-93d7-4c6f-9404-bdbfc14419f4")
                        });
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderTime = new DateTime(2024, 3, 8, 14, 16, 36, 221, DateTimeKind.Local).AddTicks(7523),
                            Status = 1,
                            UserId = new Guid("8a820adb-93d7-4c6f-9404-bdbfc14419f4")
                        });
                });
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 8, 14, 16, 36, 219, DateTimeKind.Local).AddTicks(6541));
                    ...
                    b.Property<DateTime?>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 8, 14, 16, 36, 219, DateTimeKind.Local).AddTicks(7183));
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "kha.jpg",
                            ConcurrencyStamp = "2dedfe3c-0793-4a81-bf0e-0947c1a59c30",
                            Email = "kha@gmail.com",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBbBCHhIpdXIigkiX/E61eqKprto+uRRceLSbFATVezgyrVjyy5+y9sT228zA0fBZg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "admin.jpg",
                            ConcurrencyStamp = "a6e469f3-df16-4af9-bb34-c5d0853bb44a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEdPlJ7IsxVE8KVka6W4uzYl6bbub1rnNP8ul++m6Hdvhxu/VXCXjy07PnLdpi1Yyg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "nhan.jpg",
                            ConcurrencyStamp = "6abcd2ef-7753-4739-bb2e-d58cae6f51e8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOvu4eD9+TulQToC+vmK1OFz9w4KNufCNzvULLJH0OKsrq+ksLf5Iq5Bxf37i6ciPA==",
                            PhoneNumber = "0123456789",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("OfficeMenStore.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ba494e03-e514-464c-b806-7a9ad23b1fdc",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b9d99601-5105-4a62-a335-a279ac4185fd",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
