...
export function DashboardNavbar() {
  ...
  return (
    <Navbar
      ...
      className="block backdrop-saturate-200 backdrop-blur-2xl bg-opacity-80 border border-white/80 w-full max-w-full px-4 bg-white text-white rounded-xl transition-all sticky top-4 z-40 py-3 shadow-md shadow-blue-gray-500/5"
      fullWidth
      blurred={fixedNavbar}
    >
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex items-center">
          ...
          {/* <Dropdown variant="text" color="blue-gray" className="hidden items-center gap-1 px-4 xl:flex normal-case"> */}
          {currentUser ? (
            <Menu>
              <MenuHandler>
                <Avatar
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem className="flex items-center gap-2" onClick={navigatesignin}>
                  <Typography variant="small" className="font-medium">
                    Sign In
                  </Typography>
                </MenuItem>
                <MenuItem className="flex items-center gap-2" onClick={navigatesignup}>
                  <Typography variant="small" className="font-medium">
                    Sign Up
                  </Typography>
                </MenuItem>
